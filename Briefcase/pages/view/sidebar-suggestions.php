    ...
    <div class="card-header border-0">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold text-gray-900">Other <span class="text-primary fw-bold">BSITBA</span> Tamaraws</span>
            </h3>
        ...
        <div class="card-body pt-5">
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    <div class="flex-grow-1 me-2">
                        ...
                        <span class="text-muted fw-semibold d-block fs-7">BSITBA Student at FEU Institute of Technology</span>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center pt-5">
                <a href="#" class="btn btn-sm btn-light-primary w-100 fw-bold">
                    View All Tamaraws
                </a>
            </div>
        </div>
