...
$lost_items = [
  ['id'=>101,'name'=>'Black Backpack','category'=>'Bags','category_class'=>'badge-bags','icon'=>'🎒','floor'=>'14th Floor, Library','date'=>'May 3, 2026','time'=>'2:30 PM','description'=>'Adidas bag, has a small keychain of a yellow duck attached to the zipper, initials "R.T." written inside with marker. Black straps, minor scuff on the front pocket.'],
...
<div class="laf-hiw-container">
  ...
  <div class="laf-hiw-steps">
    <div class="laf-hiw-step">
      ...
      <div class="hiw-content">
        ...
        <p>Fill in the item name, category, last known location, date &amp; time, and a detailed description with unique identifiers.</p>
      </div>
    </div>
    <div class="laf-hiw-step">
  ...
  <div class="laf-card-body">
    <div class="laf-grid laf-grid-4">
      ...
      <div class="laf-lost-card laf-card-clickable" onclick="window.location.href='/LAF/pages/lost-item-details/index.php?id=<?= (int)$item['id'] ?>'">
