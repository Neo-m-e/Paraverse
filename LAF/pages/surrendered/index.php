                ...
                <div class="laf-grid laf-grid-4" id="items-grid">
                  <?php foreach ($items as $item): ?>
                    <div class="laf-item-card laf-card-clickable <?= htmlspecialchars($item['cat_key']) ?>"
                      data-item-id="<?= (int)$item['id'] ?>" onclick="window.location.href='../item-details/index.php?id=<?= (int)$item['id'] ?>'">
                      ...
                      <div class="item-meta dash-date" data-real="📅 <?= htmlspecialchars($item['date']) ?>">📅 ●●● ●●, ●●●●</div>
