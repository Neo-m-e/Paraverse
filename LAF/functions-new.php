...
function LAF_GET_CLAIMED_ITEMS() {
  return [
    4 => ['id'=>4,'name'=>'Blue Backpack','category'=>'Bags','category_class'=>'badge-bags','floor'=>'14th Floor, Library','claimed_by'=>'Jenny B. Calot','date_claimed'=>'May 5, 2026', 'icon' => '🎒', 'image' => '/LAF/assets/images/fan.webp'],
    5 => ['id'=>5,'name'=>'Keys','category'=>'Personal Essentials','category_class'=>'badge-essentials','floor'=>'1st Floor, Parking','claimed_by'=>'Kristin V. Dy','date_claimed'=>'May 4, 2026', 'icon' => '🔑', 'image' => '/LAF/assets/images/watch.webp'],
    6 => ['id'=>6,'name'=>'Eyeglasses','category'=>'Accessories','category_class'=>'badge-accessories','floor'=>'3rd Floor, Library','claimed_by'=>'Roel M. Tan','date_claimed'=>'May 3, 2026', 'icon' => '🕶️', 'image' => '/LAF/assets/images/fan.webp'],
    7 => ['id'=>7,'name'=>'Smartphone','category'=>'Electronics','category_class'=>'badge-electronics','floor'=>'5th Floor, Study Area','claimed_by'=>'Dana P. Reyes','date_claimed'=>'May 2, 2026', 'icon' => '📱', 'image' => '/LAF/assets/images/calculator.jpg'],
  ];
}
