        ...
        <div class="row d-flex align-items-start justify-content-between pt-10">
          <div class="col-lg-5 my-5">
            <a href="/discover/" class="d-flex align-items-center mb-5" onclick="KTApp.showPageLoading()">
              <img src="/LAF/assets/images/LAF-logo.svg" class="h-35px me-2">
            </a>
            <p class='text-gray-700 fs-2 '>Just Tap to Track; You may find it in the App!</p>
            <p class='text-gray-600 fs-4 mb-0'>
              Lost & Found is a lookup platform that helps students, teachers, and staff recover lost items within school premises. Easily track and claim belongings to stay organized and save time.
            </p>
          </div>
