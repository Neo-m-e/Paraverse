/**
 * DISCOURSE — Rich Text Editor JS
 * File: assets/js/dc-editor.js
 *
 * Shared editor logic for create-post, edit-post, and edit-poll.
 * Each page binds its own editor element via window.DC_EDITOR_ID.
 */
